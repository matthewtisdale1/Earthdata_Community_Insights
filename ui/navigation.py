...
def goto_dashboard() -> None:
    st.switch_page(_get_page("dashboard"))


def goto_needs() -> None:
    st.switch_page(_get_page("needs"))
...
def tools_link(
    label: str = "Back to Earthdata Tools",
    icon: str = ":material/arrow_back:",
) -> None:
